...
const baseMetrics: MetricDefinition[] = [
  ...
  },
  {
    ...
    includedInComposite: true,
    history: [
      { date: "1998-01-01", value: 71 },
      { date: "2000-01-01", value: 112 },
      { date: "2002-01-01", value: 82 },
      { date: "2004-01-01", value: 88 },
      { date: "2006-01-01", value: 94 },
      { date: "2008-01-01", value: 90 },
      { date: "2010-01-01", value: 79 },
      { date: "2012-01-01", value: 83 },
      { date: "2014-01-01", value: 95 },
      { date: "2016-01-01", value: 103 },
      { date: "2018-01-01", value: 125 },
